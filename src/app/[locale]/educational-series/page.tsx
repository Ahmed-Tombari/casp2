          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            {series.map((item, idx) => (
              <Link
                key={idx}
                href={item.href}
                className="group relative bg-white rounded-[3rem] p-10 md:p-16 shadow-mentor-shadow border border-thom-light transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl hover:shadow-primary/10 overflow-hidden"
              >
                ...
                <h2 className="text-3xl md:text-4xl font-extrabold text-thom-dark mb-6 group-hover:text-primary transition-colors">
                  {item.title}
                </h2>
                <p className="text-xl text-thom-dark/60 leading-relaxed mb-10">
                  {item.description}
                </p>
