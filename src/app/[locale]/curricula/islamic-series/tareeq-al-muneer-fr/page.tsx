...
export async function generateMetadata({
  ...
  const t = await getTranslations({ locale: locale, namespace: 'islamicSeries.tareeqAlMuneerFr' });

  return {
    title: t('title'),
    description: t('description'),
    alternates: {
      canonical: `/${locale}/curricula/tareeq-al-muneer-fr`,
      languages: {
        ar: '/ar/curricula/tareeq-al-muneer-fr',
        fr: '/fr/curricula/tareeq-al-muneer-fr',
        en: '/en/curricula/tareeq-al-muneer-fr',
      },
    },
  };
}
            ...
            {stages.map((stage) => (
              ...
              >
                ...
                <div className="text-center sm:rtl:text-right sm:ltr:text-left pt-2">
                   ...
                   <Link href={`/curricula/tareeq-al-muneer-fr/level-${stage.id}`} className="inline-flex items-center gap-2 text-brand-navy font-bold hover:gap-3 transition-all text-sm uppercase tracking-wider">
