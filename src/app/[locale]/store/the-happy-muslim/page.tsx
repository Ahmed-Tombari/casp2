            ...
            {books.map((book) => (
              ...
              >
                ...
                <div>
                   ...
                   <Link href={`/store/the-happy-muslim/book-${book.id}`} className="inline-flex items-center gap-2 text-brand-navy font-bold hover:gap-3 transition-all text-xs uppercase tracking-wider">
