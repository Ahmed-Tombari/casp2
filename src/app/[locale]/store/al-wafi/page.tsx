      ...
      <section className="relative overflow-hidden bg-brand-navy pt-32 pb-28 text-center rounded-b-[4rem] shadow-soft-lg z-10">
        ...
        <div className="container mx-auto max-w-7xl px-4 relative z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
             <button className="px-8 py-4 bg-brand-orange text-white rounded-xl font-bold shadow-3d hover:shadow-3d-pressed hover:translate-y-1 transition-all flex items-center justify-center gap-2">
