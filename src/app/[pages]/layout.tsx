...
export default async function PagesLayout({
  ...
  // Ensure that the incoming `page` is valid
  if (!routing.locales.includes(page as Locale)) {
    notFound();
  }
  ...
  return (
    <html
      lang={page}
      dir={isRTL(page as Locale) ? "rtl" : "ltr"}
      key={page}
    ...
    >
      ...
      >
        ...
        <NextIntlClientProvider messages={messages} locale={page}>
          <ThemeProvider
            attribute="class"
            defaultTheme="light"
            enableSystem={false}
