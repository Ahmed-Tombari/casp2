...
let tabrep = [];
let vraireps = ["a21", "a36", "a14", "a40", "a35", "a24", "a39", "space",
    "a7", "a40", "a27", "a42", "a28", "a40", "a35", "a13", "a39", "space",
    "a13", "a36", "a26", "a40", "a35", "a43", "a39"
];
...
let audio97 = document.getElementById("audio97");
...
function verification() {
    ...
    window.location.href = "index97.html";
